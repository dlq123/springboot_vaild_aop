...
//@Component
//@Aspect
//public class ParamValidAspectBankList {
//
//    private static final Logger log = LoggerFactory.getLogger(ParamValidAspectBankList.class);
//
//    /**
...
//
//                    //不对所有等参数进行校验，含有Validate 才会走这个实际的校验
...
//
//                        //通过递归得倒最后一层的泛型
//                        Object object=isListType(field,args[i]);
//                        if(object == null){
//                            continue;
//                        }
...
//     * @return
//     */
//    public static Object isListType(Field field,Object object) throws IllegalAccessException {
//        if (List.class.isAssignableFrom(field.getType())){
...
//                if(pt.getActualTypeArguments()[0].getClass().isAssignableFrom(ParameterizedTypeImpl.class)  ){
//                    return null;
//                }
//                Class<? extends Object> actualClazz = (Class<? extends Object>) pt.getActualTypeArguments()[0];
//                if(basicType(actualClazz)){
//                    return null;
//                }
//                //获取List中泛型中到字段
...
//                return isListType(fields[0],objectList.get(0));
//
//
//            }
//        }else{
